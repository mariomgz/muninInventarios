        ...
        switch (opcion) {
            ...
            case "Agregar": //Agregar Registro
                ...
                if (clienteDAO.crearRegistro()) {
                    ...
                    request.setAttribute("mensajeError", "El cliente NO se registró correctamente");
            ...
            case "Actualizar": //Actualizar Registro  
                ...
                if (clienteDAO.actualizarRegistro()) {
                    ...
                    request.setAttribute("mensajeError", "El cliente NO se actualizó correctamente");
                }
                request.getRequestDispatcher("cliente.jsp").forward(request, response);
                break;
            ...
            case "Borrar": //Borrar Registro
                ...
                if (clienteVO == null) {
                    ...
                    request.setAttribute("mensajeExito", "El cliente se borró correctamente");

                } else {

                    request.setAttribute("mensajeError", "El cliente NO se eliminó");
                }
                request.getRequestDispatcher("cliente.jsp").forward(request, response);
                break;
