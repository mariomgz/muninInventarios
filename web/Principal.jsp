...
<html class="loading" lang="es-419">
    <head>
    ...
    <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
                ...
                <ul class="nav navbar-nav align-items-center ml-auto">
                    ...
                    <li class="nav-item dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle dropdown-user-link"
                           id="dropdown-user" href="Cliente" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false">
        ...
        <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            <div class="navbar-header" style="height: 15%;">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item mr-auto">                    
                        ...
                        <a class="navbar-brand" href="Principal.jsp"><span class="brand-logo">
                            </span>
            ...
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class=" nav-item"><a class="d-flex align-items-center" href="inicio.jsp" target="myFrame"><i
                                data-feather="home"></i><span class="menu-title text-truncate"
                                data-i18n="Inicio">Inicio</span></a>
                    </li>                    

                    <li class=" nav-item"><a class="d-flex align-items-center" href="cliente.jsp" target="myFrame"><i data-feather="user"></i><span
                                class="menu-title text-truncate" data-i18n="Clientes">Clientes</span></a>                        
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="proveedor.jsp" target="myFrame"><i data-feather="users"></i><span
                                class="menu-title text-truncate" data-i18n="Invoice">Proveedores</span></a>                        
                    </li>

                    <li class=" nav-item"><a class="d-flex align-items-center" href="producto.jsp" target="myFrame"><i data-feather="database"></i><span
                                class="menu-title text-truncate" data-i18n="Invoice">Productos</span></a>                        
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="nuevaVenta.jsp" target="myFrame"><i data-feather="upload"></i><span
                                class="menu-title text-truncate" data-i18n="Invoice">Ventas</span></a>                        
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="nuevaCompra.jsp" target="myFrame"><i data-feather="download"></i><span
                                class="menu-title text-truncate" data-i18n="Invoice">Compras</span></a>                       
                    </li>
        ...
        <div class="app-content content">  
            ...
            <div class="content-wrapper" >
                <iframe scrolling="no" name="myFrame" src="inicio.jsp" style="width: 100%;height: 1100px;"></iframe> 
