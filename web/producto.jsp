                                ...
                                <tbody> 
                                    ...
                                    <tr>                                     
                                        ...
                                        <td class="btn-group">
                                            ...
                                            <a class="btn btn-sm bg-blue text-white" href="Producto?opcion=Editar&documento=<%=productoVO.getProductoId()%>"  >Editar</a>
                                            <a class="btn btn-danger btn-sm text-white" style="margin-left: 5px" href="Producto?opcion=Borrar&documento=<%=productoVO.getProductoId()%>"
