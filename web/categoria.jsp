...
<html lang="es-419">
            ...
            <div class="col-md-3 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Datos de Categoría</h4>
                    </div>  

                    <div class="card-body"> 

                        <form action="Categoria" method="post" id="frmDatosCategoria">                                
                                ...
                                <tbody> 
                                    ...
                                    <tr>                                     
                                        ...
                                        <td class="btn-group">
                                            ...
                                            <a href="Categoria?opcion=Editar&documento=<%=categoriaVO.getCategoriaId()%>" id="editar"><i data-feather="edit"></i></a>
                                            <!--
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var nombre = $('#frmDatosCategoria #categoria_id').val();


            if (nombre === "") {

                $("#frmDatosCategoria #botonesActualizar").hide()();

            } else {

                $("#frmDatosCategoria #botonesAgregar").hide()();
